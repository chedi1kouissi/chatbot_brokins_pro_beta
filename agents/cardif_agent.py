...
class CardifAgent(BaseInsurerAgent):
    """Agent specialized in handling Cardif insurance contracts."""

    def __init__(self, file_path: str):
        """Initializes the agent with its contract file path and a Gemini model."""
        super().__init__(insurer_name="cardif", model_name=INSURER_AGENT_MODEL)
        self.file_path = file_path
        self._contract_text = None

    def load_contract(self) -> str:
        """Loads the Cardif contract text from the corresponding data file."""
