...
class ZeniooMNCAPAgent(BaseInsurerAgent):
    """Agent specialized in handling Zenioo-MNCAP insurance contracts."""

    def __init__(self, file_path: str):
        """Initializes the agent with its contract file path."""
        super().__init__(insurer_name="zenioo-mncap", model_name=INSURER_AGENT_MODEL)
        self.file_path = file_path
        self._contract_text = None

    def load_contract(self) -> str:
        """Loads the Zenioo-MNCAP contract text from the corresponding data file."""
